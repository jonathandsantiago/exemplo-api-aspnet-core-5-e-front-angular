...
insert into "Produto"("ProdutoId", "Nome", "Preco", "Ativo")Values('7459eff5-51cf-45f4-a17c-c758cfc56dfc','Coca Cola 2LTS', 15, true),
...
delete from "Usuario";
insert into "Usuario"("UsuarioId", "Nome", "Login", "Password", "Perfil", "Comissao", "Ativo")
